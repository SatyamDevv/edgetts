const language_dict = {
  English: {
    ...
    "Sam (Male)": "en-HK-SamNeural",
    "Connor (Male)": "en-IE-ConnorNeural",
    "Prabhat (Male)": "en-IN-PrabhatNeural",
    "Ryan (Male)": "en-GB-RyanNeural",
    "Mitchell (Male)": "en-NZ-MitchellNeural",
    "James (Male)": "en-PH-JamesNeural",
    "Wayne (Male)": "en-SG-WayneNeural",
    "Elimu (Male)": "en-TZ-ElimuNeural",
    "Luke (Male)": "en-ZA-LukeNeural",
    "Neerja (Male)": "en-IN-NeerjaNeural",
    ...
    "Asilia (Female)": "en-KE-AsiliaNeural",
    "Chilemba (Female)": "en-KE-ChilembaNeural",
    "Abeo (Female)": "en-NG-AbeoNeural",
    "Ezinne (Female)": "en-NG-EzinneNeural",
    "Rosa (Female)": "en-PH-RosaNeural",
    "Luna (Female)": "en-SG-LunaNeural",
    "Imani (Female)": "en-TZ-ImaniNeural",
    "Leah (Female)": "en-ZA-LeahNeural",
    "Yan (Female)": "en-HK-YanNeural",
  },
  Hindi: {
